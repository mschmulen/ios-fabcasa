...
class LocalMessageViewController: UIViewController, UITableViewDataSource,  UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell:MyTableViewCell = tableView.dequeueReusableCellWithIdentifier(self.cellIdentifier) as MyTableViewCell
