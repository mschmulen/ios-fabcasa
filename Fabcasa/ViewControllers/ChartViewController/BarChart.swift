...
class BarChart: UIView {
    ...
    var strokeColor: UIColor = ChartStyle.Instance.BarStrokeColor
    ...
    */
    var labelTextColor: UIColor = ChartStyle.Instance.LabelColor
    ...
    */
    ...
    func strokeChart() {
        ...
        if showLabel{
            ...
            for var index:Int = 0; index < xLabels.count; ++index {
                ...
                if labelAddCount == xLabelSkip {
                    ...
                    var label:ChartLabel = ChartLabel(frame: CGRectZero)
        ...
        for valueObj: AnyObject in yValues{
            ...
            bar = Bar(frame: CGRectMake(barXPosition, //Bar X position
        ...
        if showChartBorder{
            ...
            chartBottomLine.strokeColor =  ChartStyle.Instance.BarChartBottomLineColor.CGColor;
            ...
            chartLeftLine.strokeColor = ChartStyle.Instance.BarChartLeftLineColor.CGColor
    ...
    override init(frame: CGRect)
    {
        ...
        barBackgroundColor = ChartStyle.Instance.BackgroundColor
        clipsToBounds = true
