...
class LineChart: UIView{
        ...
        didSet{
            ...
            if showLabel {
                ...
                for var index = 0;index < xLabels.count; ++index {
                    ...
                    var label:ChartLabel = ChartLabel(frame: CGRect(x:  labelX, y: chartMargin + chartCavanHeight!, width: xLabelWidth, height: chartMargin))
    ...
    var yLabels: NSArray = []{
        didSet{
            ...
            for count : AnyObject in yLabels
            {
                ...
                var label: ChartLabel = ChartLabel(frame: CGRect(x: 0.0, y: CGFloat(labelY), width: CGFloat(chartMargin + 5.0), height: CGFloat(yLabelHeight) ) )
    ...
    */
    ...
    var chartData: NSArray = []{
        didSet{
            ...
            for chart : AnyObject in chartData{
                ...
                var chartObj = chart as LineChartData
    ...
    var axisColor:UIColor = ChartStyle.Instance.LineChartAxisColor
    ...
    func touchPoint(touches: NSSet!, withEvent event: UIEvent!){
        ...
        for linePoints:AnyObject in pathPoints {
            ...
            for var i:NSInteger = 0; i < (linePointsArray.count - 1); i += 1{
                ...
                var p1:CGPoint = (linePointsArray[i] as ChartValue).point
                var p2:CGPoint = (linePointsArray[i+1] as ChartValue).point
    ...
    */
    ...
    func strokeChart(){
        ...
        for var lineIndex = 0; lineIndex < chartData.count; lineIndex++ {
            var chartData:LineChartData = self.chartData[lineIndex] as LineChartData
            ...
            for var i:Int = 0; i < chartData.itemCount; i++ {
                ...
                case LineChartData.LineChartPointStyle.LineChartPointStyleCycle:
                    ...
                    // Square style point
                case LineChartData.LineChartPointStyle.LineChartPointStyleSquare:
                ...
                case LineChartData.LineChartPointStyle.LineChartPointStyleTriangle:
                ...
                linePointsArray.addObject(ChartValue(point: CGPointMake(x, y)))
            ...
            if chartData.color != UIColor.blackColor() {
                ...
                chartLine.strokeColor = ChartStyle.Instance.LineChartLineColor.CGColor
                pointLayer.strokeColor = ChartStyle.Instance.LineChartLineColor.CGColor
            }
            ...
            if chartData.inflexionPointStyle != LineChartData.LineChartPointStyle.LineChartPointStyleNone {
