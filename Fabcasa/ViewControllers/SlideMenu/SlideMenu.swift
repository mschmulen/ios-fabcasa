...
@objc protocol SlideMenuProtocol {
    var sideMenu : SlideMenu? { get }
    func setContentViewController(contentViewController: UIViewController)
}

enum SlideMenuAnimation : Int {
    case None
    case Default
}
...
extension UIViewController {
    ...
    internal func sideMenuController () -> SlideMenuProtocol? {
    ...
    internal func topMostController () -> SlideMenuProtocol? {
        ...
        while( topController.presentedViewController is SlideMenuProtocol ) {
